...
And on click, the user lands on the Workspace Home with status 201
And a default workspace named "{display_name}'s workspace" exists
...
Then the system rejects the second click with code TOKEN_USED
...
_Last sync: 2026-05-24T23:31:35.011Z_
