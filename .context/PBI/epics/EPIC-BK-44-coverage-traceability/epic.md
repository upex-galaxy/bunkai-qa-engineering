...
**Jira Key:** [BK-44](https://upexgalaxy67.atlassian.net/browse/BK-44)
**Priority:** Medium
**Status:** Planning
...
| --- | ----- | ------ | -------- | ------ |
| [BK-45](https://upexgalaxy67.atlassian.net/browse/BK-45) | TMS-Traceability | Render full US to bug evidence chain in one read | - | Medium | Shift-Left QA |
| [BK-46](https://upexgalaxy67.atlassian.net/browse/BK-46) | TMS-Coverage | Surface untested ACs and modules with not-run filter | - | Medium | Shift-Left QA |
| [BK-47](https://upexgalaxy67.atlassian.net/browse/BK-47) | TMS-Coverage | Compute time-to-green per user story from run and bug history | - | Medium | Shift-Left QA |
| [BK-48](https://upexgalaxy67.atlassian.net/browse/BK-48) | TMS-Traceability | Filter the chain by verdict, module, and date range | - | Medium | Shift-Left QA |
| [BK-49](https://upexgalaxy67.atlassian.net/browse/BK-49) | TMS-Activity | Stream a read-side feed over the existing activity log | - | Medium | Shift-Left QA |
| [BK-50](https://upexgalaxy67.atlassian.net/browse/BK-50) | TMS-Traceability | Export the assembled chain as a read-only snapshot | - | Medium | Shift-Left QA |
