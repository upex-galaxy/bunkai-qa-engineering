...
[View in Jira](https://jira.upexgalaxy.com.net/browse/BK-11)
...
- Same PATCH route as rename (BK-10), but the handler branches on whether `parent*module*id` is present.
...
_Last sync: 2026-05-24T23:31:40.148Z_
